...
class UserFriendshipsControllerTest < ActionController::TestCase
	context "#index" do
		context "when not logged in" do
			should "redirect to the login page" do
				get :index #when we get a new user_friendship
	...
	context "#new" do
		context "when not logged in" do
			should "redirect to the login page" do
				get :new #when we get a new user_friendship
				assert_response :redirect
			end
		end
	...
	context "#accept" do
		...
		context "when logged in" do
			...
			should "accept a user friendship" do
				assert assigns(:user_friendship)
	...
	context "#edit" do
		context "when not logged in" do
			should "redirect to the login page" do
				get :edit, id: 1 #when we get a new user_friendship
				assert_response :redirect
			end
		end
		...
		context "when logged in" do	
			...
			should "assign friend to user_friendship" do
				assert assigns(:friend)
			end
